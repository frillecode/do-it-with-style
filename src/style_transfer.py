...
base_image_path = keras.utils.get_file("white_noise.jpg", "https://live.staticflickr.com/8465/8376267144_b0c41f8d65_b.jpg")
...
#%%
''' Define functions for computing style transfer loss
...
#%%
''' Feature extraction model retrieving intermediate activations of VGG19
'''
...
#%%
''' Training loop
Performs gradient descent to minimize loss and save resulting image every 100 iterations
'''
